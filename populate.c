//This file populate.c contain dummy data and populate function
#include "contact.h"
// Dummy contact data
...
//Function definition which have dummy data if file not opened then we use this for reference
